...
const pushInOrder = function (word: string, prefixes: string[]) {
	let i = 0;
...
export default function recursePrefix(node: Record<string, any>, prefix: string, sorted: boolean, prefixes: string[] = []) {
	let word = prefix;
